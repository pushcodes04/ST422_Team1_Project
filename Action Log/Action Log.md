...
| A002 | 001 | Review and approve Management Plan against audit structure | ZA | 2026-02-22 | Closed | Team1_Management_Plan_ST422.md | Management plan reviewed and approved against audit structure. |
| A003 | 001 | Establish repository structure, README, data allocation and tracking system | PA | 2026-02-22 | In Progress | Management_Plan.html | [To be completed on close] |
...
| A006 | 002 | Set up GitHub collaboration workflow (access, branches, PR template) | YD | 2026-03-05 | In Progress | README / repository structure | [To be completed on close] |
...
| A014 | 003 | Combine STATS19 collisions, vehicles, and casualties datasets into one dataset | ZA | 2026-03-13 | Closed | Dataset merge and missing value inspect.ipynb | Clean dataset produced covering 2014–2025. |
...
| A016 | 003 | Develop IBRS-adjusted KSI series and robustness check comparing raw vs adjusted trend direction | ZA | 2026-03-09 | Closed | Week9_Road_Safety.ipynb | Adjusted series shows -284.5 KSI/yr vs raw +182.6 KSI/yr — trend reversal confirmed. |
| A017 | 003 | Build 2025 provisional data seasonality check and annualised KSI estimate | ZA | 2026-03-09 | Closed | Week9_Road_Safety.ipynb | Annualised estimate produced with seasonality adjustment. |
| A018 | 003 | Build hotspot sensitivity analysis comparing count-based vs rate-based LA rankings | ZA | 2026-03-09 | Closed | Week9_Road_Safety.ipynb | Zero overlap between top 15 count and top 15 rate LAs confirmed. |
| A019 | 003 | Fix KSI % above 100% bug in local authority chart | ZA | 2026-03-09 | Closed | Week9_Road_Safety.ipynb | Duplicate ONS code diagnostic added. |
| A020 | 003 | Rewrite Week 10 client update to decision-led prose with evidence anchoring | ZA | 2026-03-13 | Closed | Week10_Client_Update.pdf | Final client update delivered. |
...
| A023 | 004 | Identify local authorities that have shown improvement in KSI outcomes | ZA | 2026-03-18 | Closed | Week10_Improving_Analysis.ipynb | Top 5 improving authorities identified. |
| A024 | 004 | Build Week 10 improving LA analysis notebook | ZA | 2026-03-16 | Closed | Week10_Improving_Analysis.ipynb | Robustness checks completed. |
| A025 | 004 | Build Week 10 worsening LA analysis notebook | ZA | 2026-03-16 | Closed | Week10_Worsening_Analysis.ipynb | Top 5 worsening authorities identified. |
| A026 | 004 | Add boundary reorganisation completeness filter to data prep pipeline | ZA | 2026-03-16 | Closed | Dataset Work.ipynb | Filter removes 53 LAs with incomplete data. |
| A027 | 004 | Build Week 10 LA trend analysis notebook using OLS regression | ZA | 2026-03-16 | Closed | Week10_Road_Safety.ipynb | OLS trend model fitted per LA across 2014–2024. |
...
| A029 | 004 | Analyse factors affecting worst-performing local authorities | CS | 2026-03-18 | Open | Week10_Worsening_Analysis.ipynb | [To be completed on close] |
...
| A031 | 004 | Perform hypothesis testing comparing Raw KSI trends vs IBRS-adjusted trends | CS | 2026-03-18 | Closed | Week9_Road_Safety.ipynb | Not required |
