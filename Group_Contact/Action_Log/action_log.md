...
| A050 | 006     | Restructure repo into Final_Workflow/Data_Prep + Data_Analysis with Cleaned/ as the contract between them; archive draft notebooks to Draft_Work/ | ZA + PA | 2026-05-06 | Closed | Repo structure; PA commits `e954a00` (Reorganised workflow, 7 May 2026), `c46f6c5` (Added data cleaning workflow, 7 May 2026), `ee12f75` (Added data directory, 7 May 2026), `6cb3a36` (Added final analysis folder, 7 May 2026) | Master deliverable self-contained in two folders. PA confirmed final path structure and analysis folder. |
